...
if(isset($_POST["editFreelancer"])){
    ...
    $resume_link = test_input($_POST["resume_link"]);
$certificate_link = test_input($_POST["certificate_link"]);

$sql = "UPDATE freelancer 
        SET Name='$name', email='$email', contact_no='$contactNo', address='$address', gender='$gender', 
        prof_title='$prof_title', profile_sum='$profile_sum', education='$education', experience='$experience', 
        birthdate='$birthdate', skills='$skills', resume_link='$resume_link', certificate_link='$certificate_link' 
...
<div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
    <label class="col-sm-4 control-label">Resume Link</label>
    <div class="col-sm-5">
        <input type="text" class="form-control" name="resume_link" value="<?php echo $resume_link; ?>" />
    </div>
</div>

<div class="form-group">
    <label class="col-sm-4 control-label">Certificate Link</label>
    <div class="col-sm-5">
        <input type="text" class="form-control" name="certificate_link" value="<?php echo $certificate_link; ?>" />
    </div>
</div>
...
$(document).ready(function() {
    ...
    validators: {
        uri: {
            message: 'The resume link must be a valid URL'
        }
    }
},
certificate_link: {
    validators: {
        uri: {
            message: 'The certificate link must be a valid URL'
        }
    }
}
