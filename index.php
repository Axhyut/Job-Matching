...
<div class="container text-center" style="padding:4%;" id="faq">
  ...
  <div id="demo3" class="collapse">
  	<div class="card" style="padding:20px 40px 20px 40px;">
  		<h4>No. Projectworlds Freelance is absolutely free to register and explore the posted job offers, freelancers and employers.</h4>
  	</div>
  </div>
  </div>
</div>
